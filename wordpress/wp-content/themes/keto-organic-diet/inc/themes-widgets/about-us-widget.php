...
class Keto_Organic_Diet_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'Keto_Organic_Diet_About_Widget',
			__('VW About us', 'keto-organic-diet'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'keto-organic-diet' ), ) 
		);
	}
	...
	?>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','keto-organic-diet'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','keto-organic-diet'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','keto-organic-diet'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','keto-organic-diet'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','keto-organic-diet'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','keto-organic-diet'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function keto_organic_diet_about_custom_load_widget() {
	register_widget( 'Keto_Organic_Diet_About_Widget' );
}
add_action( 'widgets_init', 'keto_organic_diet_about_custom_load_widget' );