...
class Keto_Organic_Diet_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
    ...
    public function render_content(){ ?>
        <label>
            ...
            <div class="social-icon-search">
                <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'keto-organic-diet' ); ?>">
            </div>
            ...
            <ul class="icon-list clearfix">
                <?php
                $keto_organic_diet_font_awesome_icon_array = keto_organic_diet_font_awesome_icon_array();
                foreach ($keto_organic_diet_font_awesome_icon_array as $keto_organic_diet_font_awesome_icon) {
                        $icon_class = $this->value() == $keto_organic_diet_font_awesome_icon ? 'icon-active' : '';
                        echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($keto_organic_diet_font_awesome_icon).'"></i>
                        <span class="keto-organic-diet-social-class">'.esc_attr($keto_organic_diet_font_awesome_icon).'</span>
                        </li>';
                    }
                ?>
            </ul>
...
function keto_organic_diet_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'keto-organic-diet-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'keto_organic_diet_customizer_script' );

if(!function_exists('keto_organic_diet_font_awesome_icon_array')){
    function keto_organic_diet_font_awesome_icon_array(){
