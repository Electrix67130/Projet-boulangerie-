jQuery(document).ready(function($) {
    'use strict';
    var this_obj = keto_organic_diet_plugin_activate_plugin;
    ...
    $(document).on('click', '.keto-organic-diet-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message keto-organic-diet-plugin-install');
                button.addClass('button-primary keto-organic-diet-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.keto-organic-diet-recommended-plugins .keto-organic-diet-activation-note').css('display','block');
    ...
    $(document).on('click', '.keto-organic-diet-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .keto-organic-diet-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .keto-organic-diet-recommended-plugins').css('display','none');
    });
