...
<div class="container">
    <main id="maincontent" class="middle-align pt-5" role="main">
        <header>
            <h1 class="entry-title"><?php /* translators: %s: search term */ printf( esc_html__( 'Results For: %s','keto-organic-diet'), esc_html( get_search_query() ) ); ?></h1> 
        </header>
        <?php
        ...
        if($keto_organic_diet_theme_lay == 'Left Sidebar'){ ?>
            <div class="row">
                ...
                <div id="our-services" class="services col-lg-8 col-md-8">                    
                    ...
                    ?>
                    <?php if( get_theme_mod( 'keto_organic_diet_blog_pagination_hide_show',true) == 1) { ?>
                        <div class="navigation">
                            <?php keto_organic_diet_blog_posts_pagination(); ?>
